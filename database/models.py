...
class User(Base):
    ...
    backup_date: Mapped[Optional[datetime]] = mapped_column(DateTime)
    backup_hostname: Mapped[Optional[str]] = mapped_column(String(255))
    avd_dirty: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    avd_dirty_since: Mapped[Optional[datetime]] = mapped_column(DateTime)
