...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_kindle_automator_users_email'), 'users', ['email'], unique=True, schema='kindle_automator')
    op.create_index(op.f('ix_kindle_automator_users_last_used'), 'users', ['last_used'], unique=False, schema='kindle_automator')

    # Create emulator_settings table
    op.create_table('emulator_settings',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('device_identifiers',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
