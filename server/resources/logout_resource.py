        ...
        try:
            ...
            if current_state != AppState.MORE_SETTINGS:
                ...
                if current_state != AppState.MORE_SETTINGS:
                    ...
                    return {"error": f"Failed to reach MORE settings, current state: {current_state.name}"}, 500
            ...
            if not sign_out_clicked:
                ...
                try:
                    list_view = automator.driver.find_element(AppiumBy.ID, "com.amazon.kindle:id/items_screen_list")
            ...
            try:
                ...
                # Also try by text
                try:
                    dialog_title = automator.driver.find_element(AppiumBy.XPATH, "//android.widget.TextView[@text='Confirm sign out']")
            ...
            if confirm_dialog_found:
                ...
                if not sign_out_confirm_clicked:
                    # Try by text
                    try:
                        sign_out_confirm = automator.driver.find_element(AppiumBy.XPATH, "//android.widget.Button[@text='SIGN OUT']")
                        if sign_out_confirm.is_displayed():
                            sign_out_confirm.click()
                            sign_out_confirm_clicked = True
                ...
                if not sign_out_confirm_clicked:
                    ...
                    automator.store_page_source()
                    automator.driver.save_screenshot(os.path.join(automator.screenshots_dir, "logout_confirm_failed.png"))
            ...
            if new_state == AppState.SIGN_IN:
                ...
                return {"success": True, "message": "Successfully signed out", "current_state": new_state.name}, 200
